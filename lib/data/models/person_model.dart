...
class PersonModel extends Person {
  ...
  factory PersonModel.fromJson(Map<String, dynamic> map) {
    return PersonModel(
      ...
      currentPersonalTitleId:(map['CURRENT_PERSONAL_TITLE_ID']as double? ?? 0.0).toInt(),
      currentPersonalTitle:map['CURRENT_PERSONAL_TITLE']as String? ?? "",
      currentPersonalTitleEn:map['CURRENT_PERSONAL_TITLE_EN']as String? ?? "",
      academicTitleId:(map['ACADEMIC_TITLE_ID']as double? ?? 0.0).toInt(),
      ...
      currentGenderId:(map['CURRENT_GENDER_ID']as double? ?? 0.0).toInt(),
      ...
      currentMaritalStatusId:(map['CURRENT_MARITAL_STATUS_ID']as double? ?? 0.0).toInt(),
      ...
      createdByUserId:(map['CREATED_BY_USER_ID']as double? ?? 0.0).toInt(),
      updatedDatetime: map['UPDATED_DATETIME']as String? ?? "",
      updatedByUserId: (map['UPDATED_BY_USER_ID']as double? ?? 0.0).toInt(),
