...
class PersonModel extends Person {
  const PersonModel(
      { required int  personId,
        ...
        int?  staffId,
     List<StaffClassDetailModel>? staffClassDetail
      })
      : super(
    personId:personId,
  ...
  factory PersonModel.fromJson(Map<String, dynamic> json) {
   ...
   List<StaffClassDetailModel> staffClassDetail = listClassRoom.map((i) => StaffClassDetailModel.fromJson(i)).toList();
    return PersonModel(
      ...
      staffId:(json['STAFF_ID']as double? ?? 0.0).toInt(),
     staffClassDetail: staffClassDetail
    );
  }
  factory PersonModel.json(Map<String, dynamic> json) {
    var listClassRoom = json['StaffClassDetail'] as List? ?? [];
