...
class NotificationModel extends Notification{
  ...
  factory NotificationModel.fromJson(Map<String, dynamic> json) {
    ...
    List<SystemNotificationModel> systemNotifications = listSystemNotification.map((i) => SystemNotificationModel.fromJson(i)).toList();
    var listSchoolNotification = json['SchoolNotifications'] as List;
    List<SchoolNotificationModel> schoolNotifications = listSchoolNotification.map((i) => SchoolNotificationModel.fromJson(i)).toList();
